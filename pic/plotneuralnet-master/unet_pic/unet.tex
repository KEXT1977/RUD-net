...
\pic[shift={ (1,-2,0) }] at (pool_b1-east) 
    {RightBandedBox={
        name=ccr_b2,
        caption= ,
        xlabel={{ 128, 128 }},
...
\pic[shift={ (1,-2,0) }] at (pool_b2-east) 
    {RightBandedBox={
        name=ccr_b3,
        caption= ,
        xlabel={{ 256, 256 }},
...
\pic[shift={ (1,-2,0) }] at (pool_b3-east) 
    {RightBandedBox={
        name=ccr_b4,
        caption= ,
        xlabel={{ 512, 512 }},
...
\pic[shift={ (2.1,2,0) }] at (end_b8-east) 
    {Box={
        name=unpool_b9,
        caption= ,
        fill=\UnpoolColor,
...
\pic[shift={(1.55,0,0)}] at (end_b9-east) 
    {Box={
        name=soft1,
        caption=Sigmoid,
        zlabel=512,
