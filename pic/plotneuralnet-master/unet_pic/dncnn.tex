...
\pic[shift={(2,0,0)}] at (pool_conv2-east) 
    {Box={
        name=conv3,
        caption= ,
        xlabel={{64, }},
...
\pic[shift={(2,0,0)}] at (pool_conv3-east) 
    {Box={
        name=conv4,
        caption= ,
        xlabel={{64, }},
...
\pic[shift={(2,0,0)}] at (pool_conv4-east) 
    {Box={
        name=conv5,
        caption= ,
        xlabel={{64, }},
...
\pic[shift={(2,0,0)}] at (pool_conv5-east) 
    {Box={
        name=conv6,
        caption= ,
        xlabel={{64, }},
...
\pic[shift={(1.75,0,0)}] at (conv6-east) 
    {Box={
        name=soft1,
        caption=Sigmoid,
        zlabel=256,
...
\draw [connection]  (conv6-east)    -- node {\midarrow} (soft1-west);
