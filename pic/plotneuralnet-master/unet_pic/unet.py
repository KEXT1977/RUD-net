...
arch = [ 
    ...
    *block_2ConvPool( name='b4', botton='pool_b3', top='pool_b4', s_filer=32,  n_filer=512, offset="(1,0,0)", size=(16,16,5.5), opacity=0.5 ),
    ...
    #Bottleneck
    #block-005
    to_ConvConvRelu( name='ccr_b5', s_filer=16, n_filer=(1024,1024), offset="(2,0,0)", to="(pool_b4-east)", width=(8,8), height=8, depth=8, caption="Bottleneck"  ),
    to_connection( "pool_b4", "ccr_b5"),

    #Decoder
    *block_Unconv( name="b6", botton="ccr_b5", top='end_b6', s_filer=32,  n_filer=512, offset="(2.1,0,0)", size=(16,16,5.0), opacity=0.5 ),
    to_skip( of='ccr_b4', to='ccr_res_b6', pos=1.25),
    *block_Unconv( name="b7", botton="end_b6", top='end_b7', s_filer=64, n_filer=256, offset="(2.1,0,0)", size=(25,25,4.5), opacity=0.5 ),
