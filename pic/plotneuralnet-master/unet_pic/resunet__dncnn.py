...
arch = [ 
    ...
    to_Conv("conv1", 256, 64, offset="(0.5,-1,0)", to="(pool_b1-east)",  height=size-30, depth=size-30, width=6 ,fill=2,caption="ResNet50"),
    to_connection( "pool_b1", "conv1"),
    
    *block_2ConvPool( name='b2', botton='conv1', top='pool_b2', s_filer=128, n_filer=128, offset="(1,-1,0)", size=(size-7,size-7,3.5), opacity=0.5 ),
    to_Conv("conv2", 256, 64, offset="(0.5,-1,0)", to="(pool_b2-east)",  height=size-30, depth=size-30, width=6 ,fill=2,caption="ResNet50"),
    to_connection( "pool_b2", "conv2"),
    
    *block_2ConvPool( name='b3', botton='conv2', top='pool_b3', s_filer=64, n_filer=256, offset="(1,-1,0)", size=(size-14,size-14,4.5), opacity=0.5 ),
    to_Conv("conv3", 256, 64, offset="(0.5,-1,0)", to="(pool_b3-east)",  height=size-30, depth=size-30, width=6 ,fill=2,caption="ResNet50"),
    to_connection( "pool_b3", "conv3"),
    
    *block_2ConvPool( name='b4', botton='conv3', top='pool_b4', s_filer=32,  n_filer=512, offset="(1,-1,0)", size=(size-24,size-24,6.5), opacity=0.5 ),
    to_Conv("conv4", 256, 64, offset="(0.5,-1,0)", to="(pool_b4-east)",  height=size-30, depth=size-30, width=6 ,fill=2,caption="ResNet50"),
    to_connection( "pool_b4", "conv4"),
    
    #Bottleneck
    #block-005
    to_ConvConvRelu( name='ccr_b5', s_filer=16, n_filer=(1024,1024), offset="(1,-1,0)", to="(conv4-east)", width=(size-32,size-32), height=8, depth=8, caption="Bottleneck"  ),
    to_connection( "conv4", "ccr_b5"),
