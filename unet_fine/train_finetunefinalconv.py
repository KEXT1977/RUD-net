...
from model_finetune_copy import UNET
...
log_name = 'U-Net-finetunefinalconv_pred'
    ...
    class DnCNN(nn.Module):
        def __init__(self, num_layers=17, num_filters=64):
            ...
            for _ in range(num_layers - 2):
                ...
                self.dncnn.append(nn.BatchNorm2d(num_filters, eps=0.0001, momentum=0.95))
                self.dncnn.append(nn.ReLU(inplace=True))
            self.dncnn.append(nn.Conv2d(num_filters, 1,1, bias=False))
